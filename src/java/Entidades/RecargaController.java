...
import Entidades.RecargaFacade;
...
public class RecargaController implements Serializable {
    ...
    @EJB
    private Entidades.RecargaFacade ejbFacade;
    ...
    public static class RecargaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Recarga) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + RecargaController.class.getName());
            }
        }
    }
}
