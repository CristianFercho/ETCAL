...
import Entidades.TarjetaFacade;
...
public class TarjetaController implements Serializable {
    ...
    @EJB
    private Entidades.TarjetaFacade ejbFacade;
    ...
    public static class TarjetaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tarjeta) {
                ...
                return getStringKey(o.getPin());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TarjetaController.class.getName());
            }
        }
    }
}
